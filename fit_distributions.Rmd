...
survival_object <- Surv(frailty_data$days_alive, frailty_data$status) ~ frailty_data$Sex +frailty_data$Abattoir+ frailty_data$Abattoir_._Died_on_Farm + frailty_data$Total_Conditions_per_Animal
weibull.frailty(survival_object, id="Dvo_Code", data=frailty_data)
```
