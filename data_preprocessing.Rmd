...
clean_data$ConditionsbyAI[-is.na(clean_data$ConditionsbyAI) | (clean_data$ConditionsbyAI)=="*" | (clean_data$ConditionsbyAI)=="**"] <- "No"
head(clean_data)
```
...
nrow(merged_data[merged_data$Year == 2022, ])
```
```{r}
...
```{r}
write.csv(merged_wide, file="./data/merged_weather_wide.csv")
```
