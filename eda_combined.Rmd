...
```{r}
combined_data[,c("Dob", "Dod")] = lapply(combined_data[,c("Dob", "Dod")],
...
```{r}
# 2018
data_2018 <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2018")
...
# 2019
data_2019 <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2019")
...
# 2020
data_2020 <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2020")
...
# 2021
data_2021 <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2021")
...
```{r}
# 2018
data_2018_no_outliers <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2018")

# 2019
data_2019_no_outliers <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2019")

# 2020
data_2020_no_outliers <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2020")

# 2021
data_2021_no_outliers <- filter(combined_data_without_outliers, format(Dod, "%Y") == "2021")
...
animals_by_year <- data.frame(year = c("2018", "2019", "2020", "2021"),
                              count = c(nrow(data_2018_no_outliers), nrow(data_2019_no_outliers), nrow(data_2020_no_outliers), nrow(data_2021_no_outliers)),
                              mean_age_days = c(mean(data_2018_no_outliers$days_alive), mean(data_2019_no_outliers$days_alive), mean(data_2020_no_outliers$days_alive), mean(data_2021_no_outliers$days_alive)),
                              mean_age_years = c(mean(data_2018_no_outliers$years_alive), mean(data_2019_no_outliers$years_alive), mean(data_2020_no_outliers$years_alive), mean(data_2021_no_outliers$years_alive))
                              )
```
...
```{r}
write.csv(combined_data_without_outliers, file="./data/combined_data_without_outliers.csv")
