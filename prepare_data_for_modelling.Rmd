...
trsf <- trsf %>%
  ...
  pivot_wider(names_from = Abbatoir, values_from = abbatoir_present, values_fill = list(abbatoir_present = 0))
# Breed
trsf <- trsf %>%
...
beef_data <- beef_data[, -c(1,2)]
dairy_data <- dairy_data[, -c(1,2)]
```
...
write.csv(dairy_validation_data, "./data/dairyf_validation_data.csv", row.names = FALSE)
